            ...
            <a-col :xs="24">
                <a-tabs default-active-key="1">
                    <a-tab-pane key="1" tab="Allergies" force-render>
                        <a-form-item>
                            <a-textarea  v-decorator="['allergies', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]" placeholder="Allergies" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                    <a-tab-pane key="2" tab="Current Meds" force-render>
                        <a-form-item>
                            <a-textarea v-decorator="['current_meds', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]" placeholder="Current Meds" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                    <a-tab-pane key="3" tab="Medical history" force-render>
                        <a-form-item>
                            <a-textarea v-decorator="['medical_history', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]" placeholder="Medical History" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                    <a-tab-pane key="4" tab="Social History" force-render>
                        <a-form-item>
                            <a-textarea  v-decorator="['social_history', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]"  placeholder="Social History" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                    <a-tab-pane key="5" tab="Family History" force-render>
                        <a-form-item>
                            <a-textarea v-decorator="['family_history', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]" placeholder="Family History" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                </a-tabs>
            </a-col>
        ...
        <a-row class="mt-1 mb-1">
            <a-col :xs="24">
                <div layout="vertical" class="emr-inline-inputs">
                    <a-form-item
                        label="BP">
                        <a-input v-decorator="['bp', { rules: [{ max: 10, message: 'Please enter a maximum of 10 characters.' }] }]" placeholder="BP" />
                    </a-form-item>
                    <a-form-item
                        label="Pulse" >
                        <a-input v-decorator="['pulse', { rules: [{ max: 10, message: 'Please enter a maximum of 10 characters.' }] }]" placeholder="Pulse" />
                    </a-form-item>
                    <a-form-item
                        label="Resp. Rate" >
                        <a-input v-decorator="['resp_rate', { rules: [{ max: 10, message: 'Please enter a maximum of 10 characters.' }] }]" placeholder="Resp. Rate" />
                    </a-form-item>
                     <a-form-item
                        label="Temp" >
                        <a-input v-decorator="['temp', { rules: [{ max: 10, message: 'Please enter a maximum of 10 characters.' }] }]" placeholder="Temp" />
                    </a-form-item>
                    <a-form-item
                        label="Height (in)" >
                        <a-input v-decorator="['height', {}]" placeholder="Height (in)" @input="updateBMI" />
                    </a-form-item>
                    <a-form-item
                        label="Weight (lb)" >
                        <a-input v-decorator="['weight', {}]" placeholder="Weight (lb)" @input="updateBMI" />
                    </a-form-item>
                    <a-form-item
                        label="BMI" >
            ...
            <a-col :xs="24">
                <a-tabs default-active-key="1">
                    <a-tab-pane key="1" tab="Chief Complaint" force-render>
                        <a-form-item>
                            <a-textarea  v-decorator="['chief_complaint', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]"  placeholder="Chief Complaint" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                    <a-tab-pane key="2" tab="HPI" force-render>
                        <a-form-item>
                            <a-textarea v-decorator="['hip', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]" placeholder="HPI" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                    <a-tab-pane key="3" tab="Subject" force-render>
                        <a-form-item>
                            <a-textarea v-decorator="['subject', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]" placeholder="Subject" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                    <a-tab-pane key="4" tab="Objective" force-render>
                        <a-form-item>
                            <a-textarea v-decorator="['objective', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]" placeholder="Objective" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                    <a-tab-pane key="5" tab="Assessment" force-render>
                        <a-form-item>
                            <a-textarea  v-decorator="['assessment', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]" placeholder="Assessment" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                    <a-tab-pane key="6" tab="Plan" force-render>
                        <a-form-item>
                            <a-textarea v-decorator="['plan', { rules: [{ max: 2000, message: 'Please enter a maximum of 2000 characters.' }] }]" placeholder="Plan" :rows="6" />
                        </a-form-item>
                    </a-tab-pane>
                </a-tabs>
            </a-col>
