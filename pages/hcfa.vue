    ...
    methods: 
    {
        ...
        async created() {
            ...
            const sendingData = { id: this.$auth.user.uuid, patientId: this.currentName.user_uuid, hcfaInfo: {
                ...
                number13: this.number13, number14: this.number14, number15: this.number15, number16: this.number16,
                number17: this.number17, number18: this.number18, number19: this.number19, number20: this.number20,
                // number21: this.number21, number22: this.number22, number23: this.number23, number24: this.number24,
                number25: this.number25, number26: this.number26, number27: this.number27, number28: this.number28,
                number29: this.number29, number30: this.number30, number31: this.number31, number32: this.number32,
                number33: this.number33,
            } };
            const response = await this.$api.post("/hcfa/save", sendingData);
